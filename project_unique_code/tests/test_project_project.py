...
class TestProjectSequence(TransactionCase):
    ...
    def test_sequence_after_creation(self):
        ...
        self.assertFalse(prj_f.unique_code)
        proj = prj_f.save()
        self.assertTrue(proj.unique_code)
        self.assertEqual(proj.name, proj.unique_code)
        self.assertEqual(proj.unique_code, "23-00011")
    ...
    def test_sequence_not_copied_to_another_project(self):
        ...
        self.assertEqual(proj2.unique_code, "23-00012")
    ...
    def test_name_search(self):
        ...
        self.assertEqual(proj3.unique_code, "23-00013")
