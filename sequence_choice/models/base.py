...
class Base(models.AbstractModel):
    ...
    def _get_next_sequence_code(self, vals=None):
        ...
        if choice_field_id:
            ...
            code = self._get_next_choice_sequence_code(choice_field, choice_value)
        else:
            code = super()._get_next_sequence_code()
        return code

    def _get_next_choice_sequence_code(self, choice_field, choice_value):
